...
const variables = [
    { key: 'pm2.5', label: 'PM2.5', color: '#5382F7', unit: 'μg/m³', yAxisId: 'left' },
    { key: 'pm10', label: 'PM10', color: '#FF8042', unit: 'μg/m³', yAxisId: 'left' },
    { key: 'co2', label: 'CO2', color: '#82ca9d', unit: 'ppm', yAxisId: 'right' },
    { key: 'temp', label: '온도', color: '#8884d8', unit: '°C', yAxisId: 'left' }
];
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data}>
                        ...
                        <YAxis 
                            ...
                            yAxisId="left" 
                            domain={[0, 100]} 
                            label={{ value: 'μg/m³, °C', angle: -90, position: 'insideLeft' }}
                        />
                        <YAxis 
                            stroke="#E6E6E6" 
                            yAxisId="right" 
